...
<!-- banner-->
 <div class="print">
 <?php
   			$row=$dosql->getone("SELECT * FROM `#@__infoimg` WHERE id=24");	
				?>
...
<div class="tell">
	<div class="container">
	<?php $dosql->Execute("SELECT * FROM `#@__infolist` WHERE classid=17 AND flag LIKE '%h%' AND delstate='' AND checkinfo=true ORDER BY orderid asc LIMIT 0,3");

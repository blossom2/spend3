...
<!-- <div class="subBody"> -->
	...
	<div class="print">
		<div class="container">
   			<div class="row" >
   			<ul>
   			<?php $dosql->Execute("SELECT * FROM `#@__infolist` WHERE classid=16 AND delstate='' AND checkinfo=true ORDER BY orderid asc LIMIT 0,5");
				...
				<div class="col-md-4 col-lg-4">
						<li><a href="#"><img src="<?php echo $row['picurl']; ?>" alt=""></a>
...
<!-- </div> -->
		...
		<!-- </div>
   				<ul>
					<div class="col-md-4 col-lg-4">
						<li><img src="images/12.jpg" alt=""><p>多媒体教室</p></li>
					</div>
					<div class="col-md-4 col-lg-4">
						<li><img src="images/13.jpg" alt=""><p>高级柜子</p></li>
					</div>
					<div class="col-md-4 col-lg-4">
						<li><img src="images/14.jpg" alt=""><p>教室</p></li>
					</div>
					<div class="col-md-4 col-lg-4">
						<li><img src="images/8.png" alt=""><p>潄辅县智慧教育平台</p></li>
					</div>
					<div class="col-md-4 col-lg-4">
						<li><img src="images/8.png" alt=""><p>潄辅县智慧教育平台</p></li>
					</div>
